...
wB+="In what distant deeps or skies Burnt the fire of thine eyes? On what wings dare he aspire? What the hand dare seize the fire?";
wB+="And what shoulder and what art Could twist the sinews of thy heart? And when thy heart began to beat, What dread hand and what dread feet?";
wB+="What the hammer? what the chain? In what furnace was thy brain? What the anvil? What dread grasp Dare its deadly terrors clasp?";
wB+="When the stars threw down their spears, And water\'d heaven with their tears, Did He smile His work to see? Did He who made the lamb make thee?";
wB+="Tiger, tiger, burning bright In the forests of the night, What immortal hand or eye Dare frame thy fearful symmetry?";
...
function recognizeMe() {
  ...
  recognition.onspeechend = function() { recognition.stop(); console.log("speech over");}
  recognition.onerror = function(e) { console.error(e);}
}

var colorsWiki=["Absolute Zero","Acid Green","Aero","Aero Blue",
  "African Violet",
  "Air Force Blue (RAF)",  "Air Force Blue (USAF)",  "Air Superiority Blue",  "Alabama Crimson",
  "Alabaster",
  "Alice Blue",
  "Alien Armpit",
  "Alizarin Crimson",
  ...
  "Gainsboro",
    ...
    "Lincoln Green",
    "Linen",
    "Loeen(Lopen)Look/Vomit+Indogo+Lopen+Gabriel",
    "Liseran Purple",
    "Little Boy Blue",
    "Liver",
    "Liver (Dogs)",
